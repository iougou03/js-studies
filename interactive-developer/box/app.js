...
const SWING_BOX = {"color": "#f4e55a", "mode": "swing"};
const NORMAL_BOX = {"color": "#f53d84", "mode": "normal"};
...
class App {
  constructor() {
    ...
    for (let i = 0 ; i < this.total ; i++) {
      if (i % 2 == 0) this.items[i] = new Dialog(SWING_BOX);
      else this.items[i] = new Dialog(NORMAL_BOX);
    }
